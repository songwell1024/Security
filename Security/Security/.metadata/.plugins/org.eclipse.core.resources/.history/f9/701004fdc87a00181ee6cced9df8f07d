...
public class MyFrame extends JFrame implements ActionListener, DocumentListener {
	...
	public void initFrame() throws Exception {
        ...
        Help.addActionListener(new ActionListener() {   //添加事件监听
            @Override  
            public void actionPerformed(ActionEvent e) {  
            	Help();
            }  
	...
	public void initMenu() {
		...
		aboutNote = helpMenu.add(new JMenuItem("关于加密系统(A)"));
        ...
        searchNext.addActionListener(new ActionListener() {  
            ...
            public void actionPerformed(ActionEvent e) {  
                ...
                if (a > -1) {  
                    ...
                    JOptionPane.showMessageDialog(null, "找不到您查找的内容!", "加密系统", JOptionPane.INFORMATION_MESSAGE);  
                }  
